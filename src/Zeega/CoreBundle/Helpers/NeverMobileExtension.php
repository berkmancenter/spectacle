...
use Zeega\CoreBundle\Helpers\NeverMobile;
 ...
 */
class NeverMobileExtension extends Twig_Extension
{
     ...
     */
    public function __construct(NeverMobile $mobileDetector, DeviceView $deviceView)
    {
