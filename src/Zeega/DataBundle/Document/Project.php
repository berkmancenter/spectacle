...
class Project
{
     ...
     * @return self
     */
    public function setShowMetadata($showMetadata)
    {
     ...
     * @return self
     */
    public function setAutoplayDuration($duration)
    {
    ...
    /**
     * Get autoplay duration
     *
     * @return int $autoplay
     */
    public function getAutoplayDuration()
    {
